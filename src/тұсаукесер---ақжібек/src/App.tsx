  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7] flex justify-center font-sans text-[#4a4a4a]">
      <div className="w-full max-w-[480px] bg-white shadow-2xl shadow-primary/10 min-h-screen relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-secondary/40 to-transparent pointer-events-none"></div>
        ...
        <div className="px-6 py-12 relative z-10">
          ...
          <FadeIn>
            <div className="text-center mb-10">
              <p className="text-xs tracking-[0.2em] uppercase text-primary mb-4 font-medium">Тұсаукесер тойы</p>
              <h1 className="font-serif text-5xl md:text-6xl text-[#3d3d3d] mb-8 font-medium tracking-tight">АҚЖІБЕК</h1>
          ...
          <FadeIn>
            <div className="text-center my-10 px-2">
              ...
              <p className="text-sm leading-loose text-[#6b6b6b] font-light">
                Сіздерді сүйікті қызымыз <span className="font-medium text-primary">АҚЖІБЕКТІҢ</span> тұсаукесер тойына арнайы жайылған ақ дастарханымыздың қадірлі қонағы болуға шақырамыз!
              </p>
            </div>
          </FadeIn>
                  ...
                  {Array.from({ length: 31 }).map((_, i) => {
                    ...
                    return (
                      <div key={day} className="flex justify-center items-center">
                        <span className={`w-8 h-8 flex items-center justify-center rounded-full ${isTarget ? 'bg-primary text-white shadow-md font-medium' : 'text-[#4a4a4a]'}`}>
                          {day}
                        </span>
                      </div>
                    );
          ...
          <FadeIn>
            <div className="text-center my-10">
              ...
              <div className="space-y-4 text-sm text-[#6b6b6b] font-light">
                <p><span className="font-medium text-[#4a4a4a]">17:00</span> - Қонақтардың жиналуы</p>
                <p><span className="font-medium text-[#4a4a4a]">18:00</span> - Тойдың басталуы</p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center my-10">
              <h3 className="font-serif text-2xl text-[#3d3d3d] mb-4">Мекен-жайымыз:</h3>
          ...
          <FadeIn>
            <div className="text-center my-10">
              <p className="text-sm text-[#a3a3a3] uppercase tracking-widest mb-3">Той иелері</p>
              <h3 className="font-serif text-2xl text-[#3d3d3d]">Дінмұхаммед – Әйгерім</h3>
            </div>
          </FadeIn>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <label key={option} className="flex items-center gap-3 p-3 rounded-xl border border-[#e3d5ca] bg-white cursor-pointer hover:border-primary transition-colors">
